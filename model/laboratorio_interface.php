...
public static function actualizar_laboratorio($laboratorio)
  	...
  	public static function buscar_laboratorio_Twig2($id_laboratorio)
  {
    ...
    public static function mostrar_estadistica_laboratorios()
    {
    $conexion = new Conexion();
    $query = $conexion->consulta("SELECT  laboratorio.`cod_lab` AS codigo_laboratorio, inscripcion.fecha_ingreso AS fecha_ingreso, inscripcion.fecha_baja AS fecha_baja, analito.descripcion AS analito,
